...
import { SimpleContainer, Button, Code, Card } from '@repo/ui';
...
export default function Page(): JSX.Element {
  return (
    <main
      className={`${styles.main} bg-slate-100 rounded-xl p-8 dark:bg-slate-800`}
    >
      ...
      <SimpleContainer className={styles.grid} />
    </main>
  );
}
